...
class UserProfile extends React.Component {
    ...
    componentDidMount() {
        ...
        getUser(this.props.uid).then(res => res.json()).then(data => {
            this.setState({
                user: data,
                isLoading: false
            })
...
async function getUser(uid) {
    let url = `https://us-central1-capconcept-72a90.cloudfunctions.net/adminApi/getUser/${uid}`
